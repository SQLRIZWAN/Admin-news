...
window.__newsCache = window.__newsCache || {
  list: [],
  dashRecent: [],
  catCounts: {},
  stats: null,
...
try {
  ...
  }).catch(err => console.warn('[Firestore] persistence:', err?.code || err));
} catch (e) {
  console.warn('[Firestore] persistence threw:', e);
}
...
window.__forceResync = async () => {
  try {
    ...
    try {
      const keep = {};
      ['cloudinary_api_key', 'cloudinary_api_secret', 'admin_token'].forEach(k => {
...
const CLOUDINARY = {
  ...
  folder: 'sql_users',
  uploadUrl: 'https://api.cloudinary.com/v1_1/debp1kjtm/auto/upload'
};
...
const deleteCloudinaryAssetsFor = async article => {
  const jobs = [];
  if (article.videoPublicId) jobs.push(cloudinaryDestroy(article.videoPublicId, 'video'));else if (article.videoUrl) {
    const p = cloudinaryPublicIdFromUrl(article.videoUrl);
    if (p) jobs.push(cloudinaryDestroy(p.publicId, p.resourceType));
  }
  if (article.imagePublicId) jobs.push(cloudinaryDestroy(article.imagePublicId, 'image'));else {
...
const callAI = async userPrompt => {
  for (const {
    ...
    try {
      const res = await Promise.race([puter.ai.chat(userPrompt, {
        model: id
      }), new Promise((_, rej) => setTimeout(() => rej(new Error('timeout')), 45000))]);
      let text = '';
      if (typeof res === 'string') text = res;else if (typeof res?.message?.content === 'string') text = res.message.content;else if (Array.isArray(res?.message?.content)) text = res.message.content.filter(b => b.type === 'text').map(b => b.text).join('');else if (res?.text) text = res.text;
      if (text.trim()) {
...
const Ic = ({
  ...
  const p = {
    ...
    ads: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    ...
    out: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    ...
    upload: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("polyline", {
    ...
    ok: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("polyline", {
    ...
    img: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
      x: "3",
      y: "3",
      width: "18",
      height: "18",
    ...
    phone: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      d: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.82a16 16 0 0 0 6.29 6.29l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"
    })),
    ...
    video: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("polygon", {
...
const ToastList = ({
  ...
  style: {
    ...
    background: t.type === 'ok' ? '#065f46' : t.type === 'error' ? '#7f1d1d' : '#1e3a5f',
    border: `1px solid ${t.type === 'ok' ? '#34d399' : t.type === 'error' ? '#f87171' : '#60a5fa'}`,
    color: '#fff',
    minWidth: 200,
    maxWidth: 280
  }
}, /*#__PURE__*/React.createElement(Ic, {
  n: t.type === 'ok' ? 'ok' : t.type === 'error' ? 'x' : 'bell',
  s: 14
}), t.msg)));
const useToast = () => {
  ...
  const Toast = () => /*#__PURE__*/React.createElement(ToastList, {
    list: list
  });
  return {
    add,
...
}, "Confirm Delete"), /*#__PURE__*/React.createElement("p", {
  style: {
    color: 'var(--muted)',
    fontSize: 13,
    lineHeight: 1.5
...
const ImgUpload = ({
  ...
  const isVideoUrl = v => v && (v.includes('/video/upload') || /\.(mp4|mov|avi|webm|mkv|m4v)(\?|$)/i.test(v));
  const upload = file => {
    if (!file) return;
    setErr('');
    ...
    xhr.onload = () => {
      ...
      try {
        ...
        if (json.error) {
          setErr('Cloudinary: ' + json.error.message);
          return;
        }
  ...
  return /*#__PURE__*/React.createElement("div", null, label && /*#__PURE__*/React.createElement("p", {
    ...
    onDragOver: e => {
      e.preventDefault();
      if (!busy) e.currentTarget.style.borderColor = 'var(--accent)';
    },
    onDragLeave: e => {
      e.currentTarget.style.borderColor = err ? 'var(--danger)' : value ? 'var(--success)' : 'var(--border2)';
    },
    onDrop: handleDrop
  ...
  }, "Uploading ", fileType === 'video' ? 'video' : 'image', "\u2026"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, "Please wait, don't close this page")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14,
      fontWeight: 800,
      color: 'var(--accent)',
    ...
    style: {
      height: '100%',
      borderRadius: 999,
      background: fileType === 'video' ? 'linear-gradient(90deg,var(--info),var(--accent))' : 'linear-gradient(90deg,var(--accent),var(--success))',
      width: progress + '%',
      transition: 'width .3s ease'
    }
  })), fileType === 'video' && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      marginTop: 6,
  ...
  }, "\uD83C\uDFAC Videos may take a moment \u2014 please be patient")) : value ?
  /*#__PURE__*/
  /* ── Uploaded State ── */
  React.createElement("div", null, currentIsVideo ?
  /*#__PURE__*/
  /* Video preview */
  ...
  }, "\u2705 ", currentIsVideo ? 'Video' : 'Image', " uploaded successfully"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      overflow: 'hidden',
  ...
  }, value.split('/').pop().split('?')[0])), /*#__PURE__*/React.createElement("button", {
    onClick: clear,
    style: {
      flexShrink: 0,
  ...
  React.createElement("div", {
    ...
    s: 18,
    c: "var(--muted)"
  })), accept !== 'image' && /*#__PURE__*/React.createElement("div", {
    style: {
      width: 36,
      height: 36,
      borderRadius: 10,
  ...
  }, "Tap to upload or drag & drop"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--dim)'
    }
  }, accept === 'image' ? 'JPG, PNG, WebP — max 10 MB' : accept === 'video' ? 'MP4, MOV, WebM — max 100 MB' : '🖼 Images (JPG/PNG) · 🎬 Videos (MP4/MOV)'))), err && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      padding: '8px 12px',
      background: 'rgba(248,113,113,.1)',
...
}, label.toUpperCase(), required && /*#__PURE__*/React.createElement("span", {
  style: {
    color: 'var(--accent)',
    marginLeft: 4
  }
...
const Login = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      justifyContent: 'center',
      padding: '24px 16px',
      background: 'radial-gradient(ellipse at 30% 40%, #0d2040 0%, var(--bg) 65%)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
  ...
  }, "KWT")), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: 'Outfit',
      fontSize: 28,
      fontWeight: 800,
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    u.push(db.collection('news').orderBy('timestamp', 'desc').limit(100).onSnapshot(s => {
      ...
      let brk = 0;
      docs.forEach(dt => {
        if (dt.category) cc[dt.category] = (cc[dt.category] || 0) + 1;
        if (dt.isBreaking) brk++;
      });
      const rec = docs.slice(0, 6);
      window.__newsCache.catCounts = cc;
      window.__newsCache.dashRecent = rec;
      window.__newsCache.stats = {
        ...(window.__newsCache.stats || {}),
        news: docs.length,
        breaking: brk
      };
    ...
    db.collection('users').limit(5000).get().then(s => setStats(p => ({
      ...p,
      users: s.size
    }))).catch(() => {});
    db.collection('comments').limit(5000).get().then(s => setStats(p => ({
      ...p,
      comments: s.size
    }))).catch(() => {});
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Posts by Category")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px 16px',
      display: 'flex',
      gap: 10,
  ...
  }, cat.label.split(' ')[0]), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 20,
      fontWeight: 800,
      color: cat.color,
  ...
  }, catCounts[cat.value] || 0), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      lineHeight: 1.3,
  ...
  }, cat.label.replace(/^\S+\s/, '')))))), /*#__PURE__*/React.createElement("div", {
    className: "card"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px 16px',
  ...
  }, "Recent News")), loading ? [1, 2, 3, 4, 5, 6].map(i => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: '14px 16px',
      borderBottom: '1px solid var(--border)',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        padding: '13px 16px',
        borderBottom: '1px solid rgba(26,45,74,.5)',
        display: 'flex',
        alignItems: 'center',
        gap: 12
      }
    ...
    }, fmtDate(n.timestamp)), n.category && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: catInfo?.color || 'var(--muted)',
        background: 'var(--surface2)',
        padding: '1px 7px',
        borderRadius: 999,
        border: `1px solid ${catInfo?.color || 'var(--border)'}33`
      }
    }, catInfo?.label || n.category))), n.isBreaking && /*#__PURE__*/React.createElement("span", {
      className: "badge",
      style: {
        background: 'rgba(248,113,113,.12)',
        color: 'var(--danger)',
...
const LogoPicker = ({
  ...
  const tbS = active => ({
    ...
    color: active ? '#050c18' : 'var(--muted)'
  });
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    onClick: () => setOpen(true),
    style: {
      cursor: 'pointer',
      border: `2px dashed ${value ? 'var(--success)' : 'var(--border2)'}`,
      borderRadius: 12,
      padding: 14,
      background: 'var(--surface2)',
  ...
  }, "\u2705 Logo selected"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)'
    }
  }, "Tap to change")), /*#__PURE__*/React.createElement("button", {
    onClick: e => {
      e.stopPropagation();
      onSelect('');
    },
  ...
  }, "Tap to select source logo"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--dim)',
      marginTop: 2
    }
  }, "From your logo collection"))), open && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, "\uD83C\uDFF7 Source Logo"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setOpen(false),
    style: {
      background: 'var(--surface2)',
      border: '1px solid var(--border)',
    ...
    style: tbS(tab === 'select'),
    onClick: () => setTab('select')
  }, "\uD83D\uDDBC Select Logo"), /*#__PURE__*/React.createElement("button", {
    style: tbS(tab === 'add'),
    onClick: () => setTab('add')
  ...
  }, tab === 'select' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
      marginBottom: 14
    }
  ...
  }, "No logos yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)'
    }
  }, "Go to \"Add Logo\" tab to upload your first logo")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(auto-fill,minmax(110px,1fr))',
      gap: 10
    }
  }, filtered.map(logo => /*#__PURE__*/React.createElement("div", {
    key: logo.id,
    onClick: () => {
      onSelect(logo.url);
      setOpen(false);
    ...
    style: {
      cursor: 'pointer',
      border: `2px solid ${value === logo.url ? 'var(--accent)' : 'var(--border)'}`,
      borderRadius: 10,
      padding: '10px 8px',
      background: value === logo.url ? 'rgba(245,166,35,.07)' : 'var(--surface2)',
      textAlign: 'center',
      position: 'relative',
      transition: 'border .15s'
    }
  }, value === logo.url && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 4,
      right: 4,
  ...
  }, logo.name), /*#__PURE__*/React.createElement("button", {
  ...
  }, "\uD83D\uDDD1\uFE0F"))))), tab === 'add' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, "LOGO NAME"), /*#__PURE__*/React.createElement("input", {
    className: "inp",
    value: newName,
    onChange: e => setNewName(e.target.value),
    placeholder: "e.g. BBC News, Al Jazeera, KWT News...",
    onKeyDown: e => e.key === 'Enter' && addLogo()
  })), newUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 14px',
      borderRadius: 10,
      background: 'var(--surface2)',
  ...
  }, newName || '(no name yet)'))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    onClick: addLogo,
    disabled: !newUrl || !newName.trim() || saving,
    style: {
      width: '100%',
      padding: 13,
      fontSize: 14
...
const NewsForm = ({
  ...
  const save = async () => {
    ...
    if (!form.summary.trim()) {
      toast.add('Summary is required', 'error');
      return;
    }
    setSaving(true);
    try {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, editing ? '✏️ Edit Article' : '📝 New Article'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, editing ? 'Update fields then save' : 'Fill all fields and publish')), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    onClick: save,
    disabled: saving,
    style: {
  ...
  }), " Saving\u2026") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Ic, {
    n: editing ? 'ok' : 'send',
    s: 14
  }), editing ? 'Update' : 'Publish')))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "\uD83D\uDCF0 ARTICLE INFO"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, form.title.length, " / 150 characters")), /*#__PURE__*/React.createElement(Field, {
    label: "Summary",
    required: true
  ...
  }, form.summary.length, " characters")), /*#__PURE__*/React.createElement(Field, {
    label: "Full Content (Article Body)"
  }, /*#__PURE__*/React.createElement("textarea", {
    className: "inp",
    value: form.content,
    onChange: e => F({
  ...
  }, "\u2699\uFE0F ARTICLE SETTINGS"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: 14
    ...
    style: {
      background: form.isBreaking ? 'rgba(248,113,113,.07)' : 'var(--surface)',
      border: `1.5px solid ${form.isBreaking ? 'rgba(248,113,113,.4)' : 'var(--border)'}`,
      borderRadius: 16,
      padding: 20,
      transition: 'all .2s'
    }
    ...
    style: {
      fontSize: 14,
      fontWeight: 800,
      color: form.isBreaking ? 'var(--danger)' : 'var(--text)'
    }
  }, "\uD83D\uDEA8 Breaking News"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      marginTop: 4,
  ...
  }, "Pins this article to the top of the feed with a BREAKING badge")), /*#__PURE__*/React.createElement("button", {
    className: "tog",
    style: {
      background: form.isBreaking ? 'var(--danger)' : 'var(--border2)',
      flexShrink: 0
    },
    onClick: () => F({
    ...
    className: "tog-thumb",
    style: {
      left: form.isBreaking ? '22px' : '4px'
    }
  }))), form.isBreaking && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      padding: '8px 12px',
      background: 'rgba(248,113,113,.1)',
  ...
  }, "\u26A1 This article will appear as BREAKING in the news feed")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--surface)',
      border: '1px solid var(--border)',
      borderRadius: 16,
  ...
  }, form.mediaType === 'video' ? '🎬 ARTICLE VIDEO' : '🖼 ARTICLE IMAGE'), form.mediaType === 'video' ? /*#__PURE__*/React.createElement(ImgUpload, {
    value: form.videoUrl,
    onChange: v => F({
      videoUrl: v
    }),
    ...
    label: "",
    accept: "image"
  }), form.mediaType === 'video' && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14
    }
  }, /*#__PURE__*/React.createElement("p", {
  ...
  }, "\uD83D\uDDBC VIDEO THUMBNAIL (Optional)"), /*#__PURE__*/React.createElement(ImgUpload, {
  ...
  }, "\uD83C\uDFF7 SOURCE LOGO"), /*#__PURE__*/React.createElement(LogoPicker, {
    value: form.sourceLogo,
    onSelect: v => F({
      sourceLogo: v
    })
  })), (form.title || form.imageUrl) && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--surface)',
      border: '1px solid var(--border)',
      borderRadius: 16,
  ...
  }, form.videoUrl || form.imageUrl ? form.mediaType === 'video' ? /*#__PURE__*/React.createElement("video", {
    src: form.videoUrl || form.imageUrl,
    ...
    n: form.mediaType === 'video' ? 'img' : 'img',
    s: 24,
    c: "var(--dim)"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, form.isBreaking && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      fontWeight: 800,
      color: 'var(--danger)',
  ...
  }, "\u26A1 BREAKING"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      fontWeight: 700,
      lineHeight: 1.4,
  ...
  }, form.title || 'Your headline here…'), form.summary && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      lineHeight: 1.5,
  ...
  }, form.sourceLogo && /*#__PURE__*/React.createElement("img", {
    src: form.sourceLogo,
    style: {
      width: 16,
      height: 16,
  ...
  }, form.source || 'KWT News'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, "\xB7 ", form.readTime || '3 min read'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      color: 'var(--dim)',
      marginLeft: 'auto',
  ...
  }, form.category))))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    onClick: save,
    disabled: saving,
    style: {
    ...
    n: editing ? 'ok' : 'send',
    s: 16
  }), editing ? 'Update Article' : 'Publish Article')))), /*#__PURE__*/React.createElement("style", null, `
...
const NewsManager = ({
  ...
  const isDraftDoc = n => n.status === 'draft' || n.published === false && n.status !== 'published' || !n.status && n.published === undefined && n.hidden === true && n.aiGenerated === true;
  ...
  if (view === 'form') return /*#__PURE__*/React.createElement(NewsForm, {
    editing: editing,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, news.filter(n => !isDraftDoc(n)).length, " published \xB7 ", news.filter(n => isDraftDoc(n)).length, " drafts \xB7 ", news.filter(n => n.hidden === true).length, " hidden", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      marginLeft: 8
    }
  }, "raw: ", news.length, " \xB7 proj: ", firebase.app().options.projectId))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      flexWrap: 'wrap'
    ...
    onClick: () => {
      if (confirm('This will clear the local cache and reload the admin from the server. Continue?')) window.__forceResync();
    }
  }, "\uD83D\uDD04 Force Resync"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      padding: '11px 20px',
      gap: 8,
    ...
    className: "card"
  }, loading ? [1, 2, 3, 4, 5, 6, 7, 8].map(i => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: '14px 16px',
      borderBottom: '1px solid var(--border)',
  ...
  }, "Try changing the filter or add a new article"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      marginTop: 16,
      padding: '10px 20px'
    ...
    n: "plus",
    s: 14
  }), " Add Article")) : filtered.slice(0, displayCount).map(n => /*#__PURE__*/React.createElement(React.Fragment, {
    key: n.id
  }, /*#__PURE__*/React.createElement("div", {
    className: "row",
    style: {
    ...
    n: n.videoUrl ? 'video' : 'img',
    s: 20,
    c: "var(--dim)"
  })), isDraftDoc(n) && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: 0,
      left: 0,
  ...
  }, "DRAFT"), !isDraftDoc(n) && n.hidden === true && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: 0,
      left: 0,
  ...
  }, n.title || 'Untitled Article'), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      alignItems: 'center',
  ...
  }, timeAgo(n.timestamp)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--muted)',
      background: 'var(--surface2)',
  ...
  }, n.category || 'all'), n.isBreaking && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(248,113,113,.12)',
      color: 'var(--danger)',
  ...
  }, "\u26A1 BREAKING"), n.videoUrl && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(96,165,250,.1)',
      color: '#60a5fa',
  ...
  }, "\uD83C\uDFAC VIDEO"), isDraftDoc(n) && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
  ...
  }, "\uD83D\uDCDD DRAFT"), !isDraftDoc(n) && n.hidden === true && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
  ...
  }, "\uD83D\uDE48 HIDDEN"), n.autoPosted && n.socialPostStatus && n.socialPostStatus !== 'done' && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: n.socialPostStatus === 'failed' ? 'rgba(248,113,113,.12)' : 'rgba(167,139,250,.12)',
      color: n.socialPostStatus === 'failed' ? 'var(--danger)' : '#a78bfa',
      border: '1px solid currentColor',
      fontSize: 9
    }
  }, "SOCIAL: ", n.socialPostStatus))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 5,
      flexShrink: 0,
  ...
  }, isDraftDoc(n) && /*#__PURE__*/React.createElement("button", {
    ...
    onClick: async () => {
      try {
        await db.collection('news').doc(n.id).update({
          hidden: false,
          published: true,
          status: 'published'
        });
    ...
    n: "send",
    s: 13
  })), n.videoUrl && /*#__PURE__*/React.createElement("button", {
    className: "btn btn-icon",
    title: "Play Video",
    style: {
    ...
    n: "play",
    s: 13
  })), n.videoUrl && /*#__PURE__*/React.createElement("a", {
    href: n.videoUrl,
    download: `kwtnews-${n.id}.mp4`,
    target: "_blank",
    ...
    className: "tog",
    title: n.isBreaking ? 'Remove Breaking' : 'Set Breaking',
    style: {
      background: n.isBreaking ? 'var(--danger)' : 'var(--border2)'
    },
    onClick: () => toggleBreaking(n.id, n.isBreaking)
  }, /*#__PURE__*/React.createElement("div", {
    className: "tog-thumb",
    style: {
      left: n.isBreaking ? '22px' : '4px'
    }
  })), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-icon",
    title: "Edit Article",
    ...
    n: "trash",
    s: 14
  })))), videoPlayId === n.id && n.videoUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      borderBottom: '1px solid rgba(26,45,74,.5)',
      background: '#000',
      padding: '4px 0'
    ...
    onError: e => {
      toast.add('Video load failed', 'error');
      setVideoPlayId(null);
    }
  })))), filtered.length > displayCount && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '16px',
      textAlign: 'center',
...
const AdsForm = ({
  ...
  const save = async () => {
    if (!form.title.trim()) {
      toast.add('Title required', 'error');
      return;
    }
    setSaving(true);
    try {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, editing ? '✏️ Edit Ad' : '📢 New Ad'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      marginTop: 3
    }
  }, editing ? 'Update ad details below' : 'Fill in details and create ad')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10,
      flexShrink: 0
    ...
    n: editing ? 'ok' : 'send',
    s: 15
  }), editing ? 'Update Ad' : 'Create Ad')))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 16
  ...
  }, "\uD83D\uDCE2 AD INFO"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, AD_POSITIONS.map(p => /*#__PURE__*/React.createElement("option", {
    key: p,
    value: p
  }, posLabel(p))))), /*#__PURE__*/React.createElement(Field, {
    label: "Target URL"
  }, /*#__PURE__*/React.createElement("input", {
    className: "inp",
  ...
  }, "\uD83D\uDDBC BANNER IMAGE"), /*#__PURE__*/React.createElement(ImgUpload, {
    value: form.imageUrl,
    onChange: v => F({
      imageUrl: v
    }),
    ...
    style: {
      background: form.active ? 'rgba(52,211,153,.06)' : 'var(--surface)',
      border: `1.5px solid ${form.active ? 'rgba(52,211,153,.2)' : 'var(--border)'}`,
      borderRadius: 16,
      padding: 20,
      transition: 'all .2s'
    }
    ...
    style: {
      fontSize: 14,
      fontWeight: 800,
      color: form.active ? 'var(--success)' : 'var(--text)'
    }
  }, "Active / Live"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      marginTop: 4
    }
  }, "Visible to users when active")), /*#__PURE__*/React.createElement("button", {
    className: "tog",
    style: {
      background: form.active ? 'var(--success)' : 'var(--border2)',
      flexShrink: 0
    },
    onClick: () => F({
      active: !form.active
...
const AdsManager = ({
  ...
  // Full-screen form view
  if (view === 'form') return /*#__PURE__*/React.createElement(AdsForm, {
    editing: editing,
    initialForm: formInit,
    onSave: closeForm,
    onCancel: closeForm,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, ads.length, " ads \xB7 ", ads.filter(a => a.active).length, " live")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      padding: '11px 20px',
      gap: 8,
    ...
    n: "plus",
    s: 16
  }), " Add Ad")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        padding: '12px 14px',
        borderRadius: 12,
        background: cnt > 0 ? 'rgba(245,166,35,.08)' : 'var(--surface)',
        border: `1px solid ${cnt > 0 ? 'rgba(245,166,35,.25)' : 'var(--border)'}`
      }
    }, /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10,
        fontWeight: 700,
        color: cnt > 0 ? 'var(--accent)' : 'var(--dim)',
        marginBottom: 4
      }
    }, posLabel(pos)), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 22,
        fontWeight: 800,
        color: cnt > 0 ? 'var(--accent)' : 'var(--border2)'
      }
    }, cnt), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10,
        color: 'var(--dim)'
      }
  ...
  })) : ads.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 56,
      textAlign: 'center',
      color: 'var(--dim)'
  ...
  }, "No ads yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      marginTop: 4
    }
  }, "Create your first ad campaign"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      marginTop: 16,
      padding: '10px 20px'
    ...
    n: "plus",
    s: 14
  }), " Add Ad")) : ads.map(a => /*#__PURE__*/React.createElement("div", {
    key: a.id,
    className: "row",
    style: {
      padding: '13px 16px',
  ...
  }, a.imageUrl ? /*#__PURE__*/React.createElement("img", {
    src: a.imageUrl,
    style: {
      width: '100%',
      height: '100%',
    ...
    className: "badge",
    style: {
      background: a.active ? 'rgba(52,211,153,.1)' : 'rgba(100,116,139,.1)',
      color: a.active ? 'var(--success)' : 'var(--muted)',
      border: `1px solid ${a.active ? 'rgba(52,211,153,.2)' : 'rgba(100,116,139,.2)'}`,
      fontSize: 9
    }
  }, a.active ? 'LIVE' : 'PAUSED')), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--dim)'
    }
  }, posLabel(a.position), " \xB7 \uD83D\uDC41 ", fmt(a.impressions), " \xB7 CTR ", ctr(a)), (a.startDate || a.endDate) && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      marginTop: 2
    }
  }, a.startDate || '…', " \u2192 ", a.endDate || '∞')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      flexShrink: 0,
    ...
    className: "tog",
    style: {
      background: a.active ? 'var(--success)' : 'var(--border2)'
    },
...
const CommentsManager = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    msg: `Delete comment by "${confirm.name}"?`,
    onYes: () => del(confirm.id),
    onNo: () => setConfirm(null)
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, comments.length, " total \xB7 ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--danger)'
    }
  }, reported, " reported"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10,
  ...
  }, [['all', 'All'], ['reported', `🚨 Reported (${reported})`]].map(([f, l]) => /*#__PURE__*/React.createElement("button", {
    key: f,
    onClick: () => setFilter(f),
    style: {
      padding: '7px 14px',
      ...
      cursor: 'pointer',
      transition: 'all .15s',
      background: filter === f ? f === 'reported' ? 'var(--danger)' : 'var(--accent)' : 'transparent',
      color: filter === f ? '#050c18' : f === 'reported' ? 'var(--danger)' : 'var(--muted)',
      borderColor: filter === f ? f === 'reported' ? 'var(--danger)' : 'var(--accent)' : f === 'reported' ? 'rgba(248,113,113,.3)' : 'var(--border)'
    }
  }, l)))), /*#__PURE__*/React.createElement("div", {
    className: "card"
  }, loading ? [1, 2, 3].map(i => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: '14px 16px',
      borderBottom: '1px solid var(--border)',
  ...
  }, "No comments found")) : filtered.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    className: "row",
    style: {
      padding: '13px 16px',
    ...
    src: c.authorPhoto || `https://ui-avatars.com/api/?name=${encodeURIComponent(c.authorName || 'U')}&background=1a2d4a&color=F5A623&size=80`,
    style: {
      width: 36,
      height: 36,
      borderRadius: '50%',
  ...
  }, c.authorName || 'Anonymous'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: 'var(--dim)'
    }
  }, timeAgo(c.timestamp)), (c.reportCount || 0) > 0 && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(248,113,113,.1)',
      color: 'var(--danger)',
  ...
  }, "\u26A0 ", c.reportCount)), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: 'var(--muted)',
      lineHeight: 1.5,
...
const UsersManager = ({
  ...
  const filtered = useMemo(() => users.filter(u => {
    ...
    const q = search.toLowerCase();
    return u.displayName?.toLowerCase().includes(q) || u.email?.toLowerCase().includes(q) || u.phoneNumber?.toLowerCase().includes(q) || u.phone?.toLowerCase().includes(q);
  }), [users, search]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    msg: `Block user "${confirm.name}"?`,
    onYes: () => {
      toggleBlock(confirm.id, false);
      setConfirm(null);
    },
    onNo: () => setConfirm(null)
  }), detailUser && /*#__PURE__*/React.createElement("div", {
    className: "modal-bg scale-in",
  ...
  }, "User Profile"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      padding: 8
    },
    ...
    src: detailUser.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(detailUser.displayName || 'U')}&background=1a2d4a&color=F5A623&size=200`,
    style: {
      width: 80,
      height: 80,
      borderRadius: '50%',
      objectFit: 'cover',
      border: `3px solid ${detailUser.blocked ? 'var(--danger)' : 'var(--accent)'}`,
      marginBottom: 12
    }
  }), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, detailUser.displayName || 'Anonymous'), detailUser.blocked && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(248,113,113,.1)',
      color: 'var(--danger)',
  ...
  }, [['📧 Email', detailUser.email || '—'], ['📱 Phone', detailUser.phoneNumber || detailUser.phone || '—'], ['🔑 Provider', providerIcon(detailUser) + ' ' + (detailUser.providerData?.[0]?.providerId || 'email')], ['📅 Joined', fmtDate(detailUser.createdAt)], ['❤️ Liked Posts', detailUser.likedPosts?.length || 0], ['🔖 Saved Posts', detailUser.savedPosts?.length || 0]].map(([k, v]) => /*#__PURE__*/React.createElement("div", {
    key: k,
    style: {
      display: 'flex',
      justifyContent: 'space-between',
  ...
  }, detailUser.blocked ? /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      width: '100%',
      padding: '11px'
    ...
    onClick: () => {
      toggleBlock(detailUser.id, true);
      setDetailUser(null);
    }
  }, /*#__PURE__*/React.createElement(Ic, {
    n: "ok",
    s: 14
  }), " Unblock User") : /*#__PURE__*/React.createElement("button", {
    className: "btn btn-red",
    style: {
      width: '100%',
      padding: '11px',
    ...
    n: "ban",
    s: 14
  }), " Block User"))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'space-between',
  ...
  }, users.length, " registered \xB7 ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--danger)'
    }
  }, users.filter(u => u.blocked).length, " blocked"))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '8px 14px',
      borderRadius: 10,
  ...
  }, fmt(users.length), " total")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, [['name', 'By Name'], ['email', 'By Email'], ['phone', 'By Phone']].map(([t, l]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: {
      display: 'flex',
      alignItems: 'center',
    ...
    n: t === 'name' ? 'users' : t === 'email' ? 'mail' : 'phone',
    s: 11
  }), " ", l)))), /*#__PURE__*/React.createElement("div", {
    className: "card"
  }, loading ? [1, 2, 3].map(i => /*#__PURE__*/React.createElement("div", {
  ...
  }, "No users found")) : filtered.map(u => /*#__PURE__*/React.createElement("div", {
    key: u.id,
    className: "row",
    style: {
      padding: '13px 16px',
    ...
    src: u.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(u.displayName || 'U')}&background=1a2d4a&color=F5A623&size=80`,
    style: {
      width: 46,
      height: 46,
      borderRadius: '50%',
      objectFit: 'cover',
      border: `2px solid ${u.blocked ? 'var(--danger)' : 'var(--border)'}`
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
  ...
  }, providerIcon(u))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minWidth: 0
    }
  ...
  }, u.displayName || 'Anonymous'), u.blocked && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(248,113,113,.1)',
      color: 'var(--danger)',
  ...
  }, u.email || '—')), (u.phoneNumber || u.phone) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 5
  ...
  }, u.phoneNumber || u.phone))), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      display: 'flex',
      gap: 6,
  ...
  }, timeAgo(u.createdAt)), u.blocked ? /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      padding: '6px 10px',
      fontSize: 11
    ...
    onClick: e => {
      e.stopPropagation();
      toggleBlock(u.id, true);
    }
  }, "Unblock") : /*#__PURE__*/React.createElement("button", {
    className: "btn btn-red",
    style: {
      padding: '6px 8px'
    },
...
const PushNotifs = ({
  ...
  const [serverKey, setServerKey] = useState(() => {
    try {
      return localStorage.getItem('fcm_sk') || '';
    } catch (e) {
      return '';
    }
  });
  ...
  const saveKey = () => {
    try {
      localStorage.setItem('fcm_sk', serverKey);
    } catch (e) {}
    toast.add('Key saved');
  };
  const send = async () => {
    if (!title.trim() || !body.trim()) {
      toast.add('Title and message required', 'error');
      return;
    }
    setSending(true);
    try {
      ...
      if (!tokens.length) {
        toast.add('No subscribers', 'error');
        setSending(false);
        return;
      }
      ...
      if (serverKey) {
        ...
        await Promise.all(batches.map(batch => fetch('https://fcm.googleapis.com/fcm/send', {
          method: 'POST',
          headers: {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Push Alerts"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, fmt(tokenCount), " subscribers")), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 20,
      marginBottom: 16
    ...
    s: 15,
    c: "var(--accent)"
  }), " Compose Alert"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, "KWT")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      fontWeight: 700,
      marginBottom: 2
  ...
  }), " Sending\u2026") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Ic, {
    n: "send",
    s: 15
  }), "Send to ", fmt(tokenCount), " Subscribers")))), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 20,
      marginBottom: 16
    ...
    s: 15,
    c: "var(--muted)"
  }), " FCM Server Key"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      marginBottom: 14,
  ...
  }, "Firebase Console \u2192 Project Settings \u2192 Cloud Messaging \u2192 Legacy server key"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
    ...
    onClick: saveKey
  }, "Save")), serverKey && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--success)',
      marginTop: 8
    }
  }, "\u2713 Saved locally")), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 20
    }
  ...
  }, "No notifications sent yet") : history.map(h => /*#__PURE__*/React.createElement("div", {
    key: h.id,
    style: {
      padding: '11px 0',
      borderBottom: '1px solid var(--border)',
  ...
  }, timeAgo(h.sentAt), " \xB7 ", fmt(h.tokenCount), " devices"))))));
};
...
const AutomationPage = ({
  ...
  const CATS = [{
    ...
    label: '🇰🇼 Kuwait',
    color: '#34d399',
    schedule: '06:00 & 18:00 KWT',
    workflow: 'auto-kuwait.yml'
  }, {
    id: 'world',
    label: '🌍 World',
    color: '#60a5fa',
    schedule: 'Every 2 hrs (12×)',
    workflow: 'auto-world.yml'
  }, {
    id: 'kuwait-jobs',
    label: '💼 Kuwait Jobs',
    color: '#a78bfa',
    schedule: '09:00 KWT / 2 days',
    workflow: 'auto-jobs.yml'
  }, {
    id: 'kuwait-offers',
    label: '🛍️ Kuwait Offers',
    color: '#f472b6',
    schedule: '10:00 KWT daily',
    workflow: 'auto-offers.yml'
  }, {
    id: 'funny-news-meme',
    label: '😂 Funny & Memes',
    color: '#fbbf24',
    schedule: '20:00 KWT daily',
    workflow: 'auto-funny.yml'
  }];
  ...
  const fetchGhRuns = async () => {
    ...
    for (const cat of CATS) {
      try {
        const r = await fetch(`https://api.github.com/repos/${GH_REPO}/actions/workflows/${cat.workflow}/runs?per_page=1`, {
          headers
        });
  ...
  const checkApis = async () => {
    ...
    // Puter.js AI
    try {
      const res = await Promise.race([puter.ai.chat('ping', {
        model: 'gpt-4o-mini'
  ...
  const saveSetup = () => {
    if (!ghToken.trim()) {
      toast.show('Enter GitHub token', 'error');
      return;
    }
  ...
  const toggleCat = async (id, cur) => {
    try {
      await db.collection('automation_config').doc(id).set({
        enabled: !cur
      }, {
        merge: true
      });
  ...
  const runNow = async cat => {
    const tok = localStorage.getItem(LS_TOKEN);
    if (!tok) {
      toast.show('Set GitHub token first', 'error');
      setShowSetup(true);
      return;
    }
    setTriggering(p => ({
    ...
    try {
      const r = await fetch(`https://api.github.com/repos/${GH_REPO}/actions/workflows/${cat.workflow}/dispatches`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${tok}`,
          'Accept': 'application/vnd.github+json',
      ...
      if (r.status === 204) {
        ...
        const d = await r.json();
        toast.show('GitHub error: ' + (d.message || r.status), 'error');
      }
    } catch (e) {
      toast.show('Trigger failed: ' + e.message, 'error');
    }
    setTriggering(p => ({
      ...p,
      [cat.id]: false
  ...
  const runAll = async () => {
    ...
    setRunningAll(true);
    try {
      const r = await fetch(`https://api.github.com/repos/${GH_REPO}/actions/workflows/run-all.yml/dispatches`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${tok}`,
          'Accept': 'application/vnd.github+json',
  ...
  const ghBadge = run => {
    if (!run) return /*#__PURE__*/React.createElement("span", {
      className: "badge",
      style: {
        background: 'rgba(136,153,180,.1)',
        color: 'var(--dim)',
        fontSize: 10
      }
    }, "\u2014");
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Auto News"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, "RSS \u2192 Script \u2192 TTS \u2192 Video \u2192 Post  \u2022  Fully automatic")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      padding: '9px 15px',
      fontSize: 13,
    ...
    onClick: runAll,
    disabled: runningAll
  }, runningAll ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: "spinner",
    style: {
      width: 13,
      height: 13
    }
  }), " Running\u2026") : /*#__PURE__*/React.createElement(React.Fragment, null, "\uD83D\uDE80 Run All")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      padding: '9px 12px',
      fontSize: 12,
    ...
    n: "cog",
    s: 14
  }))), !hasToken && /*#__PURE__*/React.createElement("div", {
  ...
  }, "Tap here to add GitHub Token \u2014 needed to trigger workflows manually")), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--accent)',
      fontSize: 18
    }
  }, "\u203A")), showSetup && /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 18,
      marginBottom: 16,
    ...
    s: 14,
    c: "var(--accent)"
  }), " GitHub Setup"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "GitHub Token"), " (for \"\u25B6 Run\" buttons):", /*#__PURE__*/React.createElement("br", null), "Go to ", /*#__PURE__*/React.createElement("strong", null, "github.com \u2192 Settings \u2192 Developer settings \u2192 Personal access tokens (classic)"), /*#__PURE__*/React.createElement("br", null), "Create token with ", /*#__PURE__*/React.createElement("code", {
    style: {
      background: 'var(--surface2)',
      padding: '1px 6px',
      borderRadius: 4,
  ...
  }, "repo"), " scope."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    ...
    placeholder: "ghp_xxxxxxxxxxxxxxxx  (GitHub token)",
    style: {
    ...
    placeholder: "Pexels API key (optional, for status check)",
    style: {
      fontSize: 12
    }
  }), /*#__PURE__*/React.createElement("input", {
    ...
    placeholder: "Cloudinary API Key (for full delete from Cloudinary)",
    style: {
      fontSize: 12
    }
  }), /*#__PURE__*/React.createElement("input", {
    ...
    onClick: saveSetup
  }, "\uD83D\uDCBE Save Credentials"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginBottom: 16,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        minWidth: 90,
        background: 'var(--surface2)',
        border: `1px solid ${ok ? 'rgba(52,211,153,.3)' : err ? 'rgba(248,113,113,.25)' : 'var(--border)'}`,
        borderRadius: 10,
        padding: '9px 11px',
        textAlign: 'center'
      }
    ...
    n: "refresh",
    s: 13,
    c: refreshingApi ? 'var(--accent)' : 'var(--muted)'
  }))), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      fontWeight: 700,
  ...
  }, "\u2014 toggle ON/OFF  \u2022  \u25B6 run now")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        background: 'var(--surface)',
        border: `1.5px solid ${enabled ? cat.color + '33' : 'var(--border)'}`,
        borderRadius: 14,
        padding: '13px 14px',
        opacity: enabled ? 1 : .6,
        transition: 'all .2s'
    ...
    }, cat.label), lastSt && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        fontWeight: 700,
        padding: '2px 7px',
    ...
    }, lastSt === 'posted' ? '✅ Posted' : lastSt === 'error' ? '❌ Error' : '⏭️ Skipped'), ghConcl && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        padding: '2px 7px',
        borderRadius: 99,
    ...
    }, "GH ", ghConcl === 'success' ? '✓' : '✗')), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 12,
        marginTop: 4,
    ...
    }, "\u23F0 ", cat.schedule), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: 'var(--muted)'
      }
    }, "Last run: ", timeAgo(cfg.lastRun)))), /*#__PURE__*/React.createElement("button", {
      onClick: () => runNow(cat),
      disabled: trig || !hasToken,
    ...
    }) : /*#__PURE__*/React.createElement(React.Fragment, null, "\u25B6 Run")), /*#__PURE__*/React.createElement("button", {
      onClick: () => toggleCat(cat.id, enabled),
      style: {
        flexShrink: 0,
        width: 44,
        height: 24,
        ...
        cursor: 'pointer',
        position: 'relative',
        background: enabled ? cat.color : 'var(--dim)',
    ...
    n: "refresh",
    s: 12
  }), " Refresh GitHub Status"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 12,
      padding: '8px 16px'
    ...
    onClick: runAll,
    disabled: runningAll
  }, runningAll ? 'Running…' : '🚀 Run All Now')), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 16
    }
  ...
  }, "\uD83D\uDCCB Activity Log"), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 8,
      fontSize: 11,
      color: 'var(--dim)',
  ...
  }, "Last 10"), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 'auto',
      fontSize: 11,
      color: 'var(--dim)',
  ...
  }, logs.length, " total")), logs.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '28px 0'
    }
  ...
  }, "No runs yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--dim)',
      marginTop: 4
    }
  }, "Press ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--text)'
    }
  }, "\u25B6 Run"), " next to any category above,", /*#__PURE__*/React.createElement("br", null), "or press ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--accent)'
    }
  }, "\uD83D\uDE80 Run All"), " to start all 5 at once.")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 5
    ...
    }, st === 'posted' ? '✅ Post' : st === 'error' ? '❌ Err' : '⏭️ Skip'), /*#__PURE__*/React.createElement("div", {
      style: {
        minWidth: 0
      }
    }, /*#__PURE__*/React.createElement("span", {
    ...
    }, cat?.label || log.category), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: 'var(--muted)',
        marginLeft: 6,
    ...
    }, log.reason || '—')), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: 'var(--dim)',
        whiteSpace: 'nowrap'
  ...
  }), logs.length > 10 && /*#__PURE__*/React.createElement("button", {
    ...
    }, "\uD83D\uDCE2 Publish All Articles"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--muted)'
      }
    }, "Sets published:true + hidden:false on every article so they appear in your news app.")), /*#__PURE__*/React.createElement("button", {
      onClick: publishAll,
      disabled: fixing,
      style: {
        flexShrink: 0,
    ...
    }, fixing ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "spinner",
      style: {
        width: 11,
        height: 11
    ...
    const testDb = async () => {
      ...
      try {
        ...
        results.push({
          name: `✍️ Write probe (_diagnostic collection)`,
          ok: true,
          count: 1,
          detail: `OK — doc id: ${ref.id}. Writes allowed.`
        });
      ...
      const tests = [{
        name: 'orderBy timestamp (silent drops if field missing)',
        fn: () => db.collection('news').orderBy('timestamp', 'desc').limit(5).get()
      }, {
        name: 'hidden==false + timestamp',
        fn: () => db.collection('news').where('hidden', '==', false).orderBy('timestamp', 'desc').limit(5).get()
      }, {
        name: 'published==true + timestamp',
        fn: () => db.collection('news').where('published', '==', true).orderBy('timestamp', 'desc').limit(5).get()
      }, {
        name: 'category==world + timestamp',
        fn: () => db.collection('news').where('category', '==', 'world').orderBy('timestamp', 'desc').limit(3).get()
      }];
    ...
    }, "\uD83D\uDD2C Database Query Test"), /*#__PURE__*/React.createElement("button", {
      onClick: () => {
        if (confirm('Clear local Firestore cache and reload?')) window.__forceResync();
      },
      style: {
        padding: '6px 12px',
        borderRadius: 8,
    ...
    }, testing ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "spinner",
      style: {
        width: 10,
        height: 10
      }
    }), " Testing\u2026") : '▶ Run Test')), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--dim)',
        marginBottom: dbStatus ? 10 : 0
      }
    }, "Tests the Firestore queries your news app uses. If server count > cache count, tap ", /*#__PURE__*/React.createElement("strong", null, "Force Resync"), "."), cacheStale && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 10,
        padding: '10px 12px',
        borderRadius: 8,
    ...
    }, "\u26A0\uFE0F Local cache is stale \u2014 server has ", server.count, " docs, cache has ", cache.count, "."), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10.5,
        color: 'var(--muted)',
        lineHeight: 1.6,
    ...
    }, "Your browser is showing old data from before the Firestore rules were fixed. Tap the button below to wipe the cache and re-fetch from the server."), /*#__PURE__*/React.createElement("button", {
      onClick: () => window.__forceResync(),
      style: {
        padding: '8px 14px',
        borderRadius: 8,
    ...
    }, "\uD83D\uDD04 Clear Cache & Reload Now")), dbStatus && /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 6
      }
    }, dbStatus.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        padding: '8px 10px',
        borderRadius: 8,
        background: 'var(--surface2)',
        border: `1px solid ${r.ok ? 'rgba(52,211,153,.3)' : 'rgba(248,113,113,.3)'}`
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
    ...
    }, r.name), r.ok && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: '#34d399',
        background: 'rgba(52,211,153,.1)',
    ...
    }, r.count, " docs")), r.ok && r.detail && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10,
        color: 'var(--dim)',
        marginTop: 4,
    ...
    }, r.detail), !r.ok && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 5
      }
    }, r.err && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10,
        color: '#f87171',
        lineHeight: 1.5
    ...
    }, "\u2705 All queries work! If news still doesn't show, run \"\uD83D\uDCE2 Publish All\" above.")), dbStatus.some(r => !r.ok) && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '10px',
    ...
    }, "\u26A0\uFE0F Some queries require Firestore indexes"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--muted)',
        lineHeight: 1.7
      }
    }, "1. Tap each \"\uD83D\uDD27 Create Index\" link above \u2192 creates index automatically", /*#__PURE__*/React.createElement("br", null), "2. Wait ~2 minutes for index to build", /*#__PURE__*/React.createElement("br", null), "3. Run this test again to confirm \u2705"))));
  })(), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: '12px 14px',
  ...
  }, "\u2139\uFE0F How it works"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      lineHeight: 1.8
  ...
  }, "Auto:"), " GitHub Actions runs on schedule (no action needed from you).", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--text)'
    }
  }, "Manual:"), " Press ", /*#__PURE__*/React.createElement("strong", null, "\u25B6 Run"), " beside a category or ", /*#__PURE__*/React.createElement("strong", null, "\uD83D\uDE80 Run All"), " to trigger now.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--text)'
    }
  }, "Toggle:"), " Green = ON (will post). Grey = OFF (skips that category).", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--text)'
    }
  }, "Voice:"), " Hindi (Devanagari) script with hi-IN Edge TTS voices.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--text)'
    }
  }, "Flow:"), " RSS feed \u2192 AI Hindi script \u2192 TTS audio \u2192 video clips \u2192 final MP4 \u2192 Firebase")));
};
...
const SettingsPage = ({
...
}, "Account & configuration")), /*#__PURE__*/React.createElement("div", {
  className: "card",
  style: {
    padding: 20,
    marginBottom: 16
  ...
  src: user.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.displayName || 'A')}&background=F5A623&color=050c18&size=100`,
  style: {
    width: 52,
    height: 52,
    borderRadius: '50%',
...
}, user.displayName || 'Admin'), /*#__PURE__*/React.createElement("p", {
  style: {
    fontSize: 12,
    color: 'var(--muted)',
    marginTop: 2
...
}, "\u2713 Logged in")))), /*#__PURE__*/React.createElement("div", {
  className: "card",
  style: {
    padding: 20
  }
  ...
  s: 15,
  c: "var(--muted)"
}), " App Info"), /*#__PURE__*/React.createElement("div", {
  style: {
    display: 'flex',
    flexDirection: 'column',
    gap: 10,
...
}, [['Project', 'KWT News'], ['Firebase', 'kwt-news'], ['Version', '2.0.0'], ['Build', '2026']].map(([k, v]) => /*#__PURE__*/React.createElement("div", {
  key: k,
  style: {
    display: 'flex',
    justifyContent: 'space-between',
...
const LogosManager = ({
  ...
  useEffect(() => {
    ...
    db.collection('logos').orderBy('name').get().then(s => {
      setLogos(s.docs.map(d => ({
        id: d.id,
        ...d.data()
      })));
      setLoading(false);
  ...
  const applyDomain = () => {
    ...
    if (!raw) {
      toast.show('Enter a domain name e.g. bbc.com', 'error');
      return;
    }
    ...
    setForm(p => ({
      ...p,
      url,
      name: p.name || raw.replace(/\.(com|net|org|kw|ae|co|uk)$/, '').replace(/\./g, ' ')
    }));
    setPreview(url);
  ...
  const searchGallery = async () => {
    if (!galleryQ.trim()) {
      toast.show('Enter search term', 'error');
      return;
    }
    setSearching(true);
    try {
  ...
  const add = async () => {
    const name = form.name.trim(),
      url = form.url.trim();
    if (!name || !url) {
      toast.show('Both name and URL required', 'error');
      return;
    }
    if (!url.startsWith('http')) {
      toast.show('URL must start with http', 'error');
      return;
    }
    setSaving(true);
    try {
  ...
  const TAB_BTN = (id, label) => /*#__PURE__*/React.createElement("button", {
    onClick: () => setTab(id),
    style: {
      padding: '7px 13px',
      borderRadius: 8,
      border: `1.5px solid ${tab === id ? 'var(--accent)' : 'var(--border)'}`,
      background: tab === id ? 'rgba(245,166,35,.12)' : 'var(--surface2)',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 38,
      borderRadius: 12,
      background: 'linear-gradient(135deg,#1a2d4a,#243a59)',
      border: '1px solid var(--border2)',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
  ...
  }, "Source Logos"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, "Logo images for news sources \u2014 used in auto-posted articles"))), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 18,
      marginBottom: 16
  ...
  }, "\u2795 Add Source Logo"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      marginBottom: 14,
  ...
  }, TAB_BTN('domain', '🌐 Domain Auto'), TAB_BTN('pixabay', '🖼️ Image Search'), TAB_BTN('phone', '📱 Phone Gallery'), TAB_BTN('url', '🔗 Paste URL')), tab === 'domain' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, "Enter the news site domain \u2014 logo fetched automatically via Clearbit."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, "Fetch")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, "Works best with major news sites. If logo doesn't load, switch to Image Search.")), tab === 'pixabay' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, "Search Pixabay for a logo image and click to select it."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }) : 'Search')), gallery.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, gallery.map(hit => /*#__PURE__*/React.createElement("div", {
    key: hit.id,
    onClick: () => pickImage(hit.webformatURL),
    style: {
      cursor: 'pointer',
      borderRadius: 8,
      overflow: 'hidden',
      border: `2px solid ${form.url === hit.webformatURL ? 'var(--accent)' : 'var(--border)'}`,
      aspectRatio: '1',
      background: '#fff',
      display: 'flex',
      alignItems: 'center',
  ...
  }))))), tab === 'phone' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, "Select an image from your phone or computer. It will be uploaded to cloud and saved as logo."), /*#__PURE__*/React.createElement("input", {
    ref: phoneInputRef,
    type: "file",
    accept: "image/*",
    style: {
  ...
  }, phoneUploading ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: "spinner",
    style: {
      width: 14,
      height: 14
    }
  }), " Uploading...") : /*#__PURE__*/React.createElement(React.Fragment, null, "\uD83D\uDCF1 Choose from Gallery")), preview && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 10,
  ...
  }, form.url))), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, "Supports JPG, PNG, SVG, WebP. Max 10MB.")), tab === 'url' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, "Paste a direct image URL for the logo."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, form.url))), /*#__PURE__*/React.createElement("input", {
    className: "inp",
    value: form.name,
  ...
  }, saving ? 'Saving…' : '💾 Save Logo'))), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 18
    }
  ...
  }, "\uD83D\uDCCB All Logos (", logos.length, ")")), loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 24
    }
  ...
  })) : logos.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 28
    }
  ...
  }, "Add logos above \u2014 matched to source names in auto-posts"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      textAlign: 'left',
      background: 'var(--surface2)',
  ...
  }, "Common sources to add:"), /*#__PURE__*/React.createElement("br", null), "BBC News (bbc.com) \u2022 Al Jazeera (aljazeera.com) \u2022 Reuters (reuters.com)", /*#__PURE__*/React.createElement("br", null), "Arab Times Online (arabtimesonline.com) \u2022 Kuwait Times (kuwaittimes.com)")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 6
  ...
  }, (logo.name || '?')[0].toUpperCase())), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minWidth: 0
    }
  ...
  }, logo.name), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      color: 'var(--dim)',
      overflow: 'hidden',
  ...
  }, logo.url)), /*#__PURE__*/React.createElement("button", {
    onClick: () => del(logo.id, logo.name),
    style: {
      background: 'rgba(248,113,113,.12)',
      border: '1px solid rgba(248,113,113,.3)',
      color: '#f87171',
...
const CategoryManager = ({
  ...
  useEffect(() => {
    ...
    if (cached && Object.keys(cached).length) {
      ...
      CATEGORIES.forEach(cat => {
        c[cat.value] = cached[cat.value] || 0;
      });
      setCounts(c);
      setLoading(false);
      return () => {};
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Manage the 5 news categories. Home feed hides special categories.")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px 16px',
      borderRadius: 12,
  ...
  }, "\u2139\uFE0F"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      fontWeight: 700,
      color: 'var(--info)',
  ...
  }, "Category Rules"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      lineHeight: 1.6
  ...
  }, "\uD83C\uDFE0 Kuwait & \uD83C\uDF0D World"), " appear on the Home feed.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--accent)'
    }
  }, "\uD83D\uDCBC Kuwait Jobs \xB7 \uD83D\uDECD\uFE0F Kuwait Offers \xB7 \uD83D\uDE02 Funny & Memes"), " are ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--danger)'
    }
  }, "hidden from Home"), " \u2014 they show only on their own tab/page."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        background: 'var(--surface)',
        border: `1.5px solid ${isSpecial ? 'rgba(245,166,35,.25)' : 'var(--border)'}`,
        borderRadius: 16,
        padding: 18,
    ...
    }, cat.label.split(' ')[0]), isSpecial ? /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        fontWeight: 800,
        padding: '3px 8px',
    ...
    }, cat.label.replace(/^\S+\s/, '')), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 10,
        color: 'var(--dim)',
        marginBottom: 12,
    ...
    }, "slug: ", cat.value), /*#__PURE__*/React.createElement("div", {
      style: {
        borderTop: '1px solid var(--border)',
        paddingTop: 12,
        display: 'flex',
      ...
      onClick: () => {
        onNavigate && onNavigate('news', cat.value);
      }
    }, /*#__PURE__*/React.createElement(Ic, {
      n: "news",
      s: 12
  ...
  }, Object.values(counts).reduce((a, b) => a + b, 0)), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--dim)'
    }
  }, "Total Articles")), CATEGORIES.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.value,
    style: {
      display: 'flex',
      flexDirection: 'column',
  ...
  }, counts[c.value] || 0), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 9,
      color: 'var(--dim)',
      textAlign: 'center',
...
const makeNewsVideo = (article, durSecs = 20) => new Promise((resolve, reject) => {
  ...
  const catInfo = CATEGORIES.find(c => c.value === article.category) || {
    label: 'World News',
    color: '#60a5fa'
  };
  ...
  const render = (bgImg, logoImg, audioStream = null) => {
    ...
    const recStream = audioStream ? new MediaStream([...videoStream.getVideoTracks(), ...audioStream.getAudioTracks()]) : videoStream;
    const mimes = audioStream ? ['video/webm;codecs=vp9,opus', 'video/webm;codecs=vp8,opus', 'video/webm'] : ['video/webm;codecs=vp9', 'video/webm'];
    ...
    const frame = () => {
      ...
      if (bgImg) {
        ...
        ov.addColorStop(0, 'rgba(5,12,24,0.92)');
        ov.addColorStop(0.55, 'rgba(5,12,24,0.75)');
        ov.addColorStop(1, 'rgba(5,12,24,0.15)');
        ctx.fillStyle = ov;
      ...
      if (bgImg && sec > 0.3) {
        ...
        const imgW = W * 0.46,
          imgX = lerp(W, W - imgW, t);
        ctx.save();
        ctx.beginPath();
        ctx.rect(W / 2 + 20, 72, imgW + 100, H - 72 - 48);
        ctx.clip();
        ...
        ig.addColorStop(0, 'rgba(5,12,24,1)');
        ig.addColorStop(1, 'rgba(5,12,24,0)');
        ctx.fillStyle = ig;
        ctx.fillRect(W / 2 + 20, 72, 140, H - 120);
        ctx.restore();
      }

      // ─── TOP HEADER BAR ────────────────────────────────────
      const hg = ctx.createLinearGradient(0, 0, 0, 68);
      hg.addColorStop(0, 'rgba(5,12,24,0.98)');
      hg.addColorStop(1, 'rgba(5,12,24,0.9)');
      ctx.fillStyle = hg;
      ctx.fillRect(0, 0, W, 68);
      ctx.fillStyle = '#F5A623';
      ctx.fillRect(0, 66, W, 3); // accent line
      // KWT NEWS wordmark
      ctx.fillStyle = '#ffffff';
      ctx.font = 'bold 30px Arial';
      ctx.fillText('KWT', 22, 45);
      ctx.fillStyle = '#F5A623';
      ctx.fillText(' NEWS', 78, 45);
      // Separator
      ...
      ctx.beginPath();
      ctx.roundRect(182, 22, 66, 26, 5);
      ctx.fill();
      ctx.fillStyle = '#fff';
      ctx.font = 'bold 12px Arial';
      ctx.fillText('● LIVE', 190, 39);
      // Date (right)
      ctx.textAlign = 'right';
      ctx.fillStyle = 'rgba(255,255,255,0.55)';
      ctx.font = '13px Arial';
      ctx.fillText(dateStr, W - 20, 42);
      ctx.textAlign = 'left';
      ...
      if (sec > 0.6) {
        ...
        ctx.save();
        ctx.beginPath();
        ctx.rect(0, 115, W * 0.54 + 30, H - 115 - 48);
        ctx.clip();
      ...
      if (sec > 4.2 && summary) {
        ...
        ctx.fillRect(22, titleLines.length * 64 + 165 - 20, W * 0.52 - 44, 1);
        ctx.fillStyle = 'rgba(210,225,245,0.88)';
        ctx.font = '21px Arial';
      ...
      if (sec > 2.8) {
        ...
        ctx.fillRect(0, ltY, W * 0.54, 90);
        ctx.fillStyle = accent;
        ctx.fillRect(0, ltY, 5, 90);
        // Source logo circle
        if (logoImg) {
          ctx.save();
          ctx.beginPath();
          ctx.arc(28, ltY + 30, 18, 0, Math.PI * 2);
          ctx.closePath();
          ctx.clip();
          ctx.drawImage(logoImg, 10, ltY + 12, 36, 36);
          ctx.restore();
        }
        ...
        ctx.fillText('SOURCE', ltx, ltY + 20);
        ctx.letterSpacing = '0px';
        ctx.fillStyle = 'rgba(255,255,255,0.9)';
        ctx.font = 'bold 16px Arial';
        ctx.fillText(source, ltx, ltY + 42);
        ctx.fillStyle = 'rgba(255,255,255,0.2)';
        ctx.fillRect(ltx, ltY + 52, W * 0.54 - ltx - 14, 1);
      ...
      // ─── TICKER BAR (bottom) ────────────────────────────────
      ctx.fillStyle = 'rgba(5,12,24,0.97)';
      ctx.fillRect(0, H - 46, W, 46);
      ctx.fillStyle = accent;
      ctx.fillRect(0, H - 47, W, 2);
      ctx.fillStyle = accent;
      ctx.fillRect(0, H - 46, 108, 46);
      ctx.fillStyle = '#050c18';
      ctx.font = 'bold 12px Arial';
      ctx.letterSpacing = '0.5px';
      ctx.fillText('LATEST', 10, H - 26);
      ctx.fillText('NEWS', 18, H - 11);
      ctx.letterSpacing = '0px';
      ctx.save();
      ctx.beginPath();
      ctx.rect(112, H - 46, W - 112, 46);
      ctx.clip();
      ...
      tickerX -= 2.2;
      if (tickerX < -ctx.measureText(tickerFull).width) tickerX = W;
...
const makeNewsVideoWithVoice = async (article, durSecs = 28) => {
  ...
  try {
    ...
    const ttsUrls = ['https://text.pollinations.ai/' + encodeURIComponent(ttsText) + '?model=openai-audio&voice=alloy&seed=1', 'https://text.pollinations.ai/' + encodeURIComponent(ttsText) + '?model=openai-audio&voice=nova&seed=42'];
    for (const ttsUrl of ttsUrls) {
      try {
        const resp = await Promise.race([fetch(ttsUrl, {
          headers: {
        ...
        audioBlobUrl = URL.createObjectURL(new Blob([buf], {
          type: 'audio/mpeg'
        }));
        ...
        const capStream = audioEl.captureStream ? audioEl.captureStream() : audioEl.mozCaptureStream ? audioEl.mozCaptureStream() : null;
  ...
  const [bgImgs, logoImg] = await Promise.all([Promise.all(allUrls.map(loadImg)), article.sourceLogo ? loadImg(article.sourceLogo) : Promise.resolve(null)]);
  ...
  return new Promise((resolve, reject) => {
    ...
    const title = (article.title || '').trim(),
      ...
      source = article.source || 'KWT News';
    const easeOut = t => 1 - Math.pow(1 - Math.min(1, t), 3),
    ...
    const recStream = audioMediaStream ? new MediaStream([...videoStream.getVideoTracks(), ...audioMediaStream.getAudioTracks()]) : videoStream;
    const mimes = audioMediaStream ? ['video/webm;codecs=vp9,opus', 'video/webm;codecs=vp8,opus', 'video/webm'] : ['video/webm;codecs=vp9', 'video/webm'];
    const mime = mimes.find(m => MediaRecorder.isTypeSupported(m)) || 'video/webm';
    let rec;
    try {
      rec = new MediaRecorder(recStream, {
      ...
      return reject(new Error('MediaRecorder: ' + e.message));
    }
    const chunks = [];
    rec.ondataavailable = e => {
      if (e.data.size > 0) chunks.push(e.data);
    ...
    if (audioStream) {
      setTimeout(() => {
        try {
          audioStream.element.play().catch(() => {});
        } catch (e) {}
      }, 1500);
    }
    ...
    const frame = () => {
      ...
      if (bgImg) {
        ctx.save();
        ctx.filter = 'blur(8px) brightness(0.25) saturate(1.4)';
        ...
        ctx.filter = 'none';
        const ov = ctx.createLinearGradient(0, 0, W, 0);
        ov.addColorStop(0, 'rgba(5,12,24,0.95)');
        ov.addColorStop(0.52, 'rgba(5,12,24,0.8)');
        ov.addColorStop(1, 'rgba(5,12,24,0.15)');
        ctx.fillStyle = ov;
        ctx.fillRect(0, 0, W, H);
      } else {
      ...
      if (bgImg && sec > 0.2) {
        ...
        ctx.save();
        ctx.globalAlpha = Math.min(initT, fadeIn);
        ctx.beginPath();
        ctx.rect(W / 2 + 14, 72, W * 0.46 + 100, H - 72 - 48);
        ctx.clip();
        ctx.save();
        ctx.translate(W - W * 0.23, 72 + (H - 72 - 48) / 2);
        ctx.scale(kbZoom, kbZoom);
        ctx.translate(panDir * (slotSec / IMG_SWITCH) * 20, 0);
        ctx.drawImage(bgImg, -W * 0.23, -(H - 72 - 48) / 2, W * 0.46, H - 72 - 48);
        ctx.restore();
        const ig = ctx.createLinearGradient(W / 2 + 14, 0, W / 2 + 140, 0);
        ig.addColorStop(0, 'rgba(5,12,24,1)');
        ig.addColorStop(1, 'rgba(5,12,24,0)');
        ctx.fillStyle = ig;
        ctx.fillRect(W / 2 + 14, 72, 130, H - 120);
        ctx.globalAlpha = 1;
        ctx.restore();
      }
      ...
      hGrad.addColorStop(0, 'rgba(3,8,18,0.98)');
      hGrad.addColorStop(1, 'rgba(8,16,36,0.95)');
      ctx.fillStyle = hGrad;
      ...
      ctx.fillText('KwtNews', 18, 46);
      ctx.fillStyle = '#F5A623';
      ctx.font = 'bold 32px Arial';
      ctx.fillText('.com', 158, 46);
      // Separator
      ...
      ctx.beginPath();
      ctx.roundRect(282, 22, 68, 28, 6);
      ctx.fill();
      ctx.fillStyle = '#fff';
      ctx.font = 'bold 12px Arial';
      ctx.fillText('● LIVE', 290, 40);
      ctx.textAlign = 'right';
      ctx.fillStyle = 'rgba(255,255,255,0.45)';
      ctx.font = '13px Arial';
      ctx.fillText(dateStr, W - 18, 42);
      ctx.textAlign = 'left';
      ...
      if (sec > 0.3) {
        ...
        ctx.fillStyle = accent;
        ctx.beginPath();
        ctx.roundRect(22, 80, 220, 32, 7);
        ctx.fill();
        ctx.fillStyle = '#050c18';
        ctx.font = 'bold 13px Arial';
        ctx.fillText(catInfo.label.replace(/^\S+\s/, '').toUpperCase(), 32, 102);
        if (article.isBreaking) {
          const bGrad = ctx.createLinearGradient(244, 80, 394, 80);
          bGrad.addColorStop(0, '#ef4444');
          bGrad.addColorStop(1, '#dc2626');
          ctx.fillStyle = bGrad;
          ctx.beginPath();
          ctx.roundRect(244, 80, 160, 32, 7);
          ctx.fill();
          ctx.fillStyle = '#fff';
          ctx.font = 'bold 13px Arial';
          ctx.fillText('⚡ BREAKING NEWS', 252, 102);
        }
        ctx.globalAlpha = 1;
      }
      ...
      if (sec > 1.0) {
        ...
        bGrad.addColorStop(0, accent);
        bGrad.addColorStop(1, accent + '88');
        ctx.fillStyle = bGrad;
        ctx.fillRect(6, 125, 5, lH);
      }
      ...
      if (sec > 0.6) {
        ctx.save();
        ctx.beginPath();
        ctx.rect(14, 115, W * 0.52 + 20, H - 115 - 50);
        ctx.clip();
        ctx.shadowColor = 'rgba(0,0,0,0.95)';
        ctx.shadowBlur = 24;
        ctx.shadowOffsetX = 2;
        ...
        titleLines.forEach((ln, idx) => {
          const ld = idx * 0.15,
            lt = easeOut(Math.max(0, (sec - 0.6 - ld) / 0.5));
          ctx.globalAlpha = lt;
          ctx.fillStyle = '#ffffff';
      ...
      if (sec > 3.5 && summary) {
        const t = easeOut((sec - 3.5) / 0.9);
        ctx.globalAlpha = t * 0.9;
        // Subtle separator line
        const sepG = ctx.createLinearGradient(22, 0, W * 0.52 - 20, 0);
        sepG.addColorStop(0, accent);
        sepG.addColorStop(1, 'transparent');
        ctx.fillStyle = sepG;
        ctx.fillRect(22, titleLines.length * 68 + 140, W * 0.52 - 40, 1.5);
        ctx.fillStyle = 'rgba(200,220,245,0.88)';
        ctx.font = '19px Arial';
      ...
      if (bgImg && sec > 1.5) {
        ...
        ctx.save();
        ctx.globalAlpha = ancT;
        // Outer glow ring
        const ringGrad = ctx.createRadialGradient(ancX, ancY, ancR - 8, ancX, ancY, ancR + 12);
        ringGrad.addColorStop(0, accent + 'cc');
        ringGrad.addColorStop(1, 'transparent');
        ctx.fillStyle = ringGrad;
        ctx.beginPath();
        ctx.arc(ancX, ancY, ancR + 12, 0, Math.PI * 2);
        ctx.fill();
        // Circular clip
        ctx.beginPath();
        ctx.arc(ancX, ancY, ancR, 0, Math.PI * 2);
        ctx.clip();
        ...
        ancOv.addColorStop(0, 'rgba(5,12,24,0.3)');
        ancOv.addColorStop(0.5, 'rgba(5,12,24,0)');
        ancOv.addColorStop(1, 'rgba(5,12,24,0.2)');
        ctx.fillStyle = ancOv;
        ctx.fillRect(ancX - ancR, ancY - ancR, ancR * 2, ancR * 2);
        ctx.restore();
        ...
        ctx.beginPath();
        ctx.roundRect(ancX - 70, ancY + ancR + 8, 140, 24, 5);
        ctx.fill();
        ctx.fillStyle = accent;
        ctx.font = 'bold 11px Arial';
        ctx.textAlign = 'center';
        ctx.fillText('KWT NEWS CORRESPONDENT', ancX, ancY + ancR + 24);
        ctx.textAlign = 'left';
        ctx.restore();
      }
      ...
      if (sec > 2.5) {
        const t = easeOut((sec - 2.5) / 0.6),
          ltY = lerp(H + 50, H - 175, t);
        // Panel background with gradient
        const ltGrad = ctx.createLinearGradient(0, ltY, W * 0.56, ltY);
        ltGrad.addColorStop(0, 'rgba(3,8,18,0.97)');
        ltGrad.addColorStop(1, 'rgba(5,14,28,0.85)');
        ctx.fillStyle = ltGrad;
        ctx.fillRect(0, ltY, W * 0.56, 95);
        ctx.fillStyle = accent;
        ctx.fillRect(0, ltY, 6, 95);
        // Logo circle
        if (logoImg) {
          ctx.save();
          ctx.beginPath();
          ctx.arc(30, ltY + 32, 20, 0, Math.PI * 2);
          ctx.closePath();
          ctx.fillStyle = 'rgba(255,255,255,0.1)';
          ctx.fill();
          ctx.clip();
          ctx.drawImage(logoImg, 10, ltY + 12, 40, 40);
          ctx.restore();
        }
        ...
        ctx.fillText('REPORTED BY', ltx, ltY + 18);
        ctx.letterSpacing = '0px';
        ctx.fillStyle = 'rgba(255,255,255,0.92)';
        ctx.font = 'bold 17px Arial';
        ctx.fillText(source, ltx, ltY + 40);
        ctx.fillStyle = 'rgba(255,255,255,0.15)';
        ctx.fillRect(ltx, ltY + 50, W * 0.56 - ltx - 16, 1);
      ...
      ctx.fillStyle = accent;
      ctx.fillRect(0, H - 51, W, 2.5);
      const tkGrad = ctx.createLinearGradient(0, H - 50, 120, H);
      tkGrad.addColorStop(0, accent);
      tkGrad.addColorStop(1, accent + 'cc');
      ctx.fillStyle = tkGrad;
      ctx.fillRect(0, H - 50, 120, 50);
      ctx.fillStyle = '#050c18';
      ctx.font = 'bold 12px Arial';
      ctx.textAlign = 'center';
      ctx.fillText('BREAKING', 60, H - 32);
      ctx.fillText('NEWS', 60, H - 15);
      ctx.textAlign = 'left';
      ctx.save();
      ctx.beginPath();
      ctx.rect(124, H - 50, W - 124, 50);
      ctx.clip();
...
const SOURCE_DOMAINS = {
  ...
  abc: 'abcnews.go.com',
  gulf: 'gulfnews.com',
  arab: 'arabtimesonline.com',
  kuwait: 'kuwaittimes.com',
  times: 'timesofkuwait.com',
  sky: 'sky.com'
};
...
const getOrCreateSourceLogo = async sourceName => {
  ...
  try {
    ...
    snap.docs.forEach(d => {
      const k = (d.data().name || '').toLowerCase();
      if (k) _logoCache.set(k, d.data().url);
    });
    ...
    if (found) {
      _logoCache.set(cacheKey, found.data().url);
...
const AINewsManager = ({
  ...
  const uploadVideoBlob = async blob => {
    ...
    const res = await fetch(`https://api.cloudinary.com/v1_1/${CLOUDINARY.cloudName}/video/upload`, {
      method: 'POST',
      body: fd
    });
    const data = await res.json();
  ...
  const openDraftEdit = d => {
    setDraftEdit({
      ...
      form: {
        ...
        summary: d.summary || '',
        content: d.content || '',
        category: d.category || 'kuwait',
        isBreaking: d.isBreaking || false,
        imageUrl: d.imageUrl || '',
        source: d.source || 'KWT News AI',
  ...
  const fetchDrafts = async () => {
    ...
    try {
      ...
      const docs = snap.docs.map(d => ({
        id: d.id,
        ...d.data()
      })).filter(d => d.aiGenerated).sort((a, b) => window.__docTime(b) - window.__docTime(a));
      setDrafts(docs);
    } catch (e) {
      console.error(e);
    }
  ...
  const getImg = async (query, forceAI = false) => {
    if (!forceAI) {
      try {
        const u = await fetchPixabay(query);
        if (u) return u;
      } catch (e) {}
    }
  ...
  const sendChat = async () => {
    ...
    try {
      ...
      const prompt = isArticleReq ? `You are a professional journalist for KWT News (Kuwait & world news platform).
...
Return ONLY JSON: {"reply": "your helpful response max 300 chars", "article": null}`;
      ...
      const replyText = parsed?.reply || (parsed ? 'Article generated! Click the button below to save it as a video draft.' : responseText.replace(/^\s*\{[\s\S]*\}\s*$/, '').trim().slice(0, 400) || '✅ Article ready! Click "Generate Video & Save Draft" below.');
      ...
      setMsgs(p => [...p, {
        role: 'ai',
        text: 'Sorry, error: ' + e.message + '. Please try again.'
      }]);
    }
    setChatBusy(false);
  };
  const saveChatDraft = async article => {
    ...
    try {
      // 1. Fetch source logo
      setVideoStatus('logo');
      toast.add('Finding source logo...', 'info');
      let sourceLogo = '';
      const src = shortSourceName(article.source || 'KWT News');
      try {
        sourceLogo = await getOrCreateSourceLogo(article.source || 'KWT News');
      } catch (e) {}

      // 2. Fetch distinct background images for video transitions (deduplicated)
      setVideoStatus('image');
      toast.add('Fetching images...', 'info');
      const titleWords = (article.title || '').split(' ').slice(0, 4).join(' ');
      const [img1, img2, img3] = await Promise.all([getImg(article.imageQuery || article.title, false).catch(() => ''), getImg(titleWords + ' news event', false).catch(() => ''), getImg((article.category || 'world') + ' news', false).catch(() => '')]);
      ...
      try {
        ...
        throw new Error('Draft save failed: ' + e2.message);
      }
      ...
      try {
        ...
        toast.add('☁️ Uploading to cloud...', 'info');
        ...
        setMsgs(p => [...p, {
          role: 'ai',
          text: '✅ Video draft saved! Go to the Drafts tab to review and publish.'
        }]);
      } catch (e2) {
        clearInterval(videoTimerRef.current);
        ...
        setMsgs(p => [...p, {
          role: 'ai',
          text: '⚠️ Draft saved (text+logo only). Video rendering failed — check Drafts tab.'
        }]);
      }
      fetchDrafts();
    } catch (e) {
...
Return ONLY valid JSON (no markdown, no code blocks):
{
  ...
  const publishDraft = async id => {
    ...
    try {
      ...
      toast.add('Publish failed', 'error');
    }
    setActionId(null);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "AI News Studio"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--muted)',
      marginTop: 2
    }
  }, "Puter.js AI \xB7 Video \xB7 Voice-over"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginBottom: 20,
    ...
    style: tbStyle('chat'),
    onClick: () => setTab('chat')
  }, "\uD83D\uDCAC AI Chat"), /*#__PURE__*/React.createElement("button", {
    style: tbStyle('drafts'),
    onClick: () => setTab('drafts')
  }, "\uD83D\uDCDD Drafts", drafts.length > 0 ? ` (${drafts.length})` : '')), tab === 'chat' && /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "\uD83C\uDFAC Video News Mode"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: 'var(--dim)',
      flex: 1
    }
  }, "AI generates article \u2192 voice-over \u2192 animated video \u2192 saved to drafts"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 5
    ...
    value: videoDur,
    onChange: e => setVideoDur(+e.target.value),
    style: {
      background: 'var(--surface)',
      border: '1px solid var(--border)',
      borderRadius: 6,
    ...
    value: 15
  }, "15s"), /*#__PURE__*/React.createElement("option", {
    value: 20
  }, "20s"), /*#__PURE__*/React.createElement("option", {
    value: 25
  }, "25s"), /*#__PURE__*/React.createElement("option", {
    value: 30
  ...
  }, m.text), m.article && /*#__PURE__*/React.createElement("div", {
    className: "card-sm fade-up",
    style: {
      maxWidth: '90%',
      overflow: 'hidden'
    }
  }, m.article.imageUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("img", {
    src: m.article.imageUrl,
    alt: "",
    style: {
      width: '100%',
      height: 160,
    ...
    onError: e => e.target.style.display = 'none'
  }), m.article.isBreaking && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      position: 'absolute',
      top: 8,
  ...
  }, CATEGORIES.find(c => c.value === m.article.category)?.label || 'News'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, "\xB7 ", m.article.readTime || '3 min read'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, "\xB7 ", m.article.source || 'KWT News')), /*#__PURE__*/React.createElement("p", {
    style: {
      fontWeight: 800,
      fontSize: 14,
      lineHeight: 1.4,
  ...
  }, m.article.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--muted)',
      lineHeight: 1.55,
  ...
  }, m.article.summary), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    disabled: videoBusy || chatBusy,
    style: {
      fontSize: 13,
      padding: '11px',
      width: '100%',
  ...
  }, "\uD83C\uDFAC Generate Video & Save Draft")), videoBusy && /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: '1px solid var(--border)',
      padding: '10px 14px',
  ...
  }, videoStatus === 'logo' ? '🏷 Finding source logo...' : videoStatus === 'image' ? '🖼 Fetching background image...' : videoStatus === 'rendering' ? '🎬 Rendering video + voice-over...' : videoStatus === 'uploading' ? '☁️ Uploading to cloud...' : '⏳ Processing...'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: '#6366f1',
      fontWeight: 700
    }
  }, videoProgress, "%")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 4,
      borderRadius: 2,
      background: 'var(--border)',
  ...
  }))), videoResult && videoResult.articleTitle === m.article.title && !videoBusy && /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: '1px solid var(--border)',
      padding: 12,
  ...
  }, "\uD83C\uDFAC Video Preview (saved to Drafts)"), /*#__PURE__*/React.createElement("video", {
    src: videoResult.url,
    controls: true,
    style: {
      width: '100%',
  ...
  }, "\u2B07\uFE0F Download .webm"))))), chatBusy && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10,
      alignItems: 'center',
  ...
  }, "AI is searching the web & writing...")), /*#__PURE__*/React.createElement("div", {
    ref: chatEndRef
  })), msgs.length <= 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 16px 10px',
      display: 'flex',
      gap: 8,
  ...
  }, ['🇰🇼 Latest Kuwait news today', '🌍 Top world news now', '💼 Kuwait job market news', '⚡ Generate breaking news'].map((s, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    ...
    n: "send",
    s: 16
  })))), tab === 'drafts' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'space-between',
  ...
  }, draftsLoading ? 'Loading...' : `${drafts.length} AI article${drafts.length !== 1 ? 's' : ''} · ${drafts.filter(d => d.hidden).length} pending review`), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    onClick: fetchDrafts,
    style: {
      fontSize: 12,
    ...
    n: "refresh",
    s: 14
  }), " Refresh")), draftsLoading ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      padding: 48
  ...
  }, "No AI drafts yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: 'var(--muted)'
    }
  }, "Use AI Chat or Auto Generate to create articles, then save them as drafts.")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    }
  }, drafts.map(d => /*#__PURE__*/React.createElement("div", {
    key: d.id,
    className: "card",
    style: {
      overflow: 'hidden'
  ...
  }, d.videoUrl ? /*#__PURE__*/React.createElement("div", {
    style: {
      width: 96,
      height: 96,
      background: '#000',
  ...
  }, "VIDEO")) : d.imageUrl && /*#__PURE__*/React.createElement("img", {
    src: d.imageUrl,
    alt: "",
    style: {
      width: 96,
  ...
  }, "AI"), d.hidden ? /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
      background: 'rgba(250,200,40,.12)',
      color: '#fbbf24',
      border: '1px solid rgba(250,200,40,.3)',
      fontSize: 9
    }
  ...
  }, "PUBLISHED"), d.isBreaking && /*#__PURE__*/React.createElement("span", {
    className: "badge",
    style: {
  ...
  }, CATEGORIES.find(c => c.value === d.category)?.label || d.category), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--dim)'
    }
  }, timeAgo(d.timestamp))), /*#__PURE__*/React.createElement("p", {
    style: {
      fontWeight: 700,
      fontSize: 13,
      lineHeight: 1.4,
  ...
  }, d.hidden ? /*#__PURE__*/React.createElement("button", {
    className: "btn btn-accent",
    style: {
      flex: 2,
      fontSize: 12,
    ...
    disabled: actionId === d.id + '-pub',
    onClick: () => publishDraft(d.id)
  }, actionId === d.id + '-pub' ? '...' : '🚀 Publish') : /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 2,
      display: 'flex',
      alignItems: 'center',
    ...
    disabled: actionId === d.id + '-del',
    onClick: () => delDraft(d.id)
  }, actionId === d.id + '-del' ? '...' : '🗑️')), draftEdit?.id === d.id && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '14px',
      borderTop: '1px solid var(--border)',
      background: 'var(--surface2)',
  ...
  }, "\u270F\uFE0F Edit Draft"), /*#__PURE__*/React.createElement("button", {
    style: {
      background: 'none',
      border: 'none',
      cursor: 'pointer',
    ...
    className: "inp",
    value: draftEdit.form.title,
    onChange: e => setDraftEdit(p => ({
      ...p,
      form: {
        ...p.form,
        title: e.target.value
    ...
    key: c.value,
    value: c.value
  }, c.label)))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      color: 'var(--dim)',
    ...
    className: `tog`,
    style: {
      background: draftEdit.form.isBreaking ? '#ef4444' : 'var(--border2)'
    },
    onClick: () => setDraftEdit(p => ({
      ...p,
      form: {
        ...p.form,
        isBreaking: !p.form.isBreaking
      }
    }))
  }, /*#__PURE__*/React.createElement("div", {
    className: "tog-thumb",
    style: {
      left: draftEdit.form.isBreaking ? 22 : 4
    }
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
  ...
  }, "\u26A1 Breaking News")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, draftSaving ? 'Saving...' : '💾 Save Changes'), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 13,
      padding: '10px'
    ...
    onClick: () => setDraftEdit(null)
  }, "Cancel"))), videoResult?.article?.id === d.id && !videoBusy && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 14px',
      borderTop: '1px solid var(--border)',
...
const MediaManager = ({
  ...
  const PLATFORMS = [{
    ...
    tokenLabel: 'Session Cookie (JSON)',
    tokenHelp: 'Open Instagram in Chrome → DevTools → Application → Cookies → copy sessionid cookie value as JSON: {"sessionid":"..."}',
    tokenField: 'cookieData',
    hasPageId: false
  }, {
    id: 'youtube',
    label: 'YouTube',
    ...
    tokenHelp: 'Go to Google OAuth Playground → authorize YouTube Data API v3 → copy Refresh Token here',
    ...
    tokenHelp: 'Go to Facebook Developers → Graph API Explorer → select your page → generate Page Access Token',
    tokenField: 'accessToken',
    hasPageId: true
  }, {
    id: 'tiktok',
    label: 'TikTok',
    color: '#69C9D0',
    bg: 'rgba(105,201,208,.08)',
    border: 'rgba(105,201,208,.22)',
    icon: /*#__PURE__*/React.createElement("svg", {
      width: "22",
      height: "22",
      viewBox: "0 0 24 24",
    ...
    tokenLabel: 'Session Cookies (JSON)',
    tokenHelp: 'Open TikTok in Chrome → DevTools → Application → Cookies → export as JSON using Cookie Editor extension',
    tokenField: 'cookieData',
    hasPageId: false
  }, {
    id: 'x',
    ...
    tokenLabel: 'API Tokens (key|secret|access|access_secret)',
    tokenHelp: 'Go to developer.twitter.com → your app → Keys and Tokens → paste as: API_KEY|API_SECRET|ACCESS_TOKEN|ACCESS_SECRET',
    tokenField: 'accessToken',
    hasPageId: false
  }];
  ...
  useEffect(() => {
    const unsub = db.collection('news').where('autoPosted', '==', true).orderBy('timestamp', 'desc').limit(30).onSnapshot(snap => {
  ...
  useEffect(() => {
    ...
    const unsub = db.collection('social_media_queue').orderBy('createdAt', 'desc').limit(30).onSnapshot(snap => {
  ...
  const openEdit = p => {
    ...
    setEditForm({
      ...
      cookieData: typeof acc.cookieData === 'object' && acc.cookieData ? JSON.stringify(acc.cookieData, null, 2) : acc.cookieData || '',
      pageId: acc.pageId || '',
      notes: acc.notes || ''
    });
    setEditing(p.id);
  ...
  const saveAccount = async (platformId, plat) => {
    ...
    try {
      ...
      if (plat.tokenField === 'cookieData' && fd.cookieData.trim()) {
        try {
          cookieData = JSON.parse(fd.cookieData);
        } catch {
          cookieData = fd.cookieData;
  ...
  const fmtStatus = (results, plat) => {
    ...
    if (!r) return null;
    return r.success ? /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'var(--success)',
        fontWeight: 700,
        fontSize: 11
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Media Hub"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'var(--muted)',
      fontSize: 13
    }
  }, "Connect social accounts & track auto-uploads")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginBottom: 20,
  ...
  }, ['accounts', 'queue', 'videos'].map(t => /*#__PURE__*/React.createElement("button", {
    key: t,
  ...
  }, t === 'accounts' ? '🔗 Accounts' : t === 'queue' ? '📤 Upload Queue' : '🎬 Videos'))), activeTab === 'accounts' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 14
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        padding: 0,
        overflow: 'hidden',
        border: `1px solid ${connected ? p.border : 'var(--border)'}`,
        borderRadius: 14
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        gap: 12,
        padding: '14px 16px',
        background: connected ? p.bg : 'transparent'
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        width: 42,
        height: 42,
        borderRadius: 12,
        background: connected ? p.bg : 'var(--surface2)',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        color: connected ? p.color : 'var(--muted)',
    ...
    }, connected ? 'Connected' : 'Disconnected')), connected && acc.username && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 12,
        color: 'var(--muted)',
        marginTop: 2
      }
    }, "@", acc.username), connected && acc.lastPostedAt && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--dim)',
        marginTop: 1
      }
    }, "Last post: ", timeAgo(acc.lastPostedAt))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8,
        flexShrink: 0
      ...
      onClick: () => disconnectAccount(p.id, p.label)
    ...
    }, isEditing ? 'Cancel' : connected ? 'Edit' : 'Connect'))), isEditing && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '14px 16px',
        borderTop: '1px solid var(--border)',
        display: 'flex',
    ...
    }, "USERNAME / HANDLE"), /*#__PURE__*/React.createElement("input", {
      className: "inp",
      style: {
        fontSize: 13
      },
      placeholder: `@${p.id}account`,
      value: editForm.username,
      onChange: e => setEditForm(f => ({
        ...f,
        username: e.target.value
      }))
    })), p.hasPageId && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        fontWeight: 700,
        color: 'var(--dim)',
    ...
    }, "PAGE ID (Facebook)"), /*#__PURE__*/React.createElement("input", {
      className: "inp",
      style: {
        fontSize: 13
      },
    ...
    }, p.tokenLabel.toUpperCase()), /*#__PURE__*/React.createElement("textarea", {
      className: "inp",
      rows: 3,
      style: {
        fontSize: 12,
      ...
      onChange: e => setEditForm(f => ({
        ...f,
        [p.tokenField === 'cookieData' ? 'cookieData' : 'accessToken']: e.target.value
      }))
    }), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
    ...
    }, p.tokenHelp)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        fontWeight: 700,
        color: 'var(--dim)',
      ...
      placeholder: "e.g. refresh every 30 days...",
      ...
      onClick: () => saveAccount(p.id, p),
      disabled: saving
    }, saving ? 'Saving...' : '💾 Save & Connect'), /*#__PURE__*/React.createElement("button", {
      className: "btn btn-ghost",
      style: {
        fontSize: 13
      },
  ...
  })))), activeTab === 'videos' && /*#__PURE__*/React.createElement("div", null, loadingVid ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 40,
      color: 'var(--muted)'
    }
  }, "Loading videos...") : videos.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 40,
      color: 'var(--muted)'
  ...
  }, "No auto-published videos yet"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--dim)',
      marginTop: 4
    }
  }, "Run automation to generate news videos")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 14
    }
    ...
    }, timeAgo(v.timestamp)), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        color: 'var(--muted)'
      }
    ...
    }, v.category), v.videoUrl && /*#__PURE__*/React.createElement("a", {
      href: v.videoUrl,
      target: "_blank",
      rel: "noopener noreferrer",
      style: {
    ...
    }, "\u25B6 View")), qEntry?.results && /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 5,
        marginTop: 6,
  ...
  }))), activeTab === 'queue' && /*#__PURE__*/React.createElement("div", null, loadingQ ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 40,
      color: 'var(--muted)'
    }
  }, "Loading queue...") : queue.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 40,
      color: 'var(--muted)'
  ...
  }, "Upload queue is empty"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: 'var(--dim)',
      marginTop: 4
    }
  }, "Social uploads will appear here after automation runs")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 12
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, q.newsTitle || 'Untitled'), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--muted)',
        marginTop: 2
      }
    }, fmtDate(q.createdAt))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: 6,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          fontSize: 10,
          fontWeight: 700,
          color: r?.success ? 'var(--success)' : r ? 'var(--danger)' : 'var(--muted)'
        }
      }, r?.success ? '✓' : r ? '✗' : '⏳', " ", plat.label));
    })), q.status === 'completed' && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 11,
        color: 'var(--dim)',
        marginTop: 6
      }
    }, successCount, "/", totalCount, " platforms posted successfully"));
  }))));
};
...
const Layout = ({
  ...
  const renderPage = () => {
    ...
    switch (page) {
      ...
      case 'news':
        return /*#__PURE__*/React.createElement(NewsManager, _extends({}, p, {
          initCat: navCat
        }));
      case 'ai':
        return /*#__PURE__*/React.createElement(AINewsManager, _extends({}, p, {
          onBack: () => goPage('dashboard')
        }));
      case 'categories':
        return /*#__PURE__*/React.createElement(CategoryManager, _extends({}, p, {
          onNavigate: navigate
        }));
      case 'ads':
        return /*#__PURE__*/React.createElement(AdsManager, p);
      case 'comments':
        return /*#__PURE__*/React.createElement(CommentsManager, p);
      case 'users':
        return /*#__PURE__*/React.createElement(UsersManager, p);
      case 'notifications':
        return /*#__PURE__*/React.createElement(PushNotifs, p);
      case 'automation':
        return /*#__PURE__*/React.createElement(AutomationPage, p);
      case 'logos':
        return /*#__PURE__*/React.createElement(LogosManager, p);
      case 'media':
        return /*#__PURE__*/React.createElement(MediaManager, p);
      case 'settings':
        return /*#__PURE__*/React.createElement(SettingsPage, _extends({
          user: user
        }, p));
      default:
        return /*#__PURE__*/React.createElement(Dashboard, null);
  ...
  return /*#__PURE__*/React.createElement("div", null, menuOpen && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 200
  ...
  }, "MENU"), PAGES.map(p => /*#__PURE__*/React.createElement("button", {
    key: p.id,
    onClick: () => goPage(p.id),
    style: {
      display: 'flex',
      ...
      border: 'none',
      cursor: 'pointer',
      color: page === p.id ? 'var(--accent)' : 'var(--text)',
      fontFamily: 'Outfit',
    ...
    n: p.icon,
    s: 18,
    c: page === p.id ? 'var(--accent)' : 'var(--muted)'
  }), p.label, page === p.id && /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: 'auto',
      width: 6,
      height: 6,
    ...
    s: 18,
    c: "var(--danger)"
  }), "Sign Out")))), /*#__PURE__*/React.createElement("aside", {
    className: "sidebar"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    src: user.photoURL || `https://ui-avatars.com/api/?name=A&background=F5A623&color=050c18`,
    style: {
      width: 28,
      height: 28,
      borderRadius: '50%',
  ...
  }, pg.label))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8
    ...
    n: "menu",
    s: 18
  })))), /*#__PURE__*/React.createElement("style", null, `@media(max-width:767px){#mob-menu{display:inline-flex!important}}`), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, renderPage())), /*#__PURE__*/React.createElement("nav", {
    className: "bnav"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, PAGES.slice(0, 5).map(p => /*#__PURE__*/React.createElement("button", {
    key: p.id,
    className: `bnav-item ${page === p.id ? 'active' : ''}`,
    onClick: () => goPage(p.id)
  }, /*#__PURE__*/React.createElement(Ic, {
    n: p.icon,
    s: 20
    ...
    className: "dot"
  }))))), /*#__PURE__*/React.createElement(toast.Toast, null));
};
...
const App = () => {
  ...
  if (checking) return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      alignItems: 'center',
      justifyContent: 'center',
      boxShadow: '0 8px 32px rgba(245,166,35,.3)'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'Outfit',
  ...
  }, "KWT")), /*#__PURE__*/React.createElement("div", {
    className: "spinner"
  }));
